...
, function(t, e, n) {
    ...
    function j(t) {
        if (!t.handlers.select) {
            ...
            _(t, "select", (function(n) {
                var r = n.target;
                A(n) || t.directSelect && r !== e || (n.isPrimary && "BUTTON" === r.tageName && r.focus(),
    ...
    function w(t, e) {
        if (l || (l = new g(document).on("interaction")),
        !t.handlers.init && !t.handlers.select) {
            var n = t.el;
            C(t, e, "blur", (function() {
                Object(a.p)(n, "jw-tab-focus"),
                t.clicking = !1
            }
            )),
...
, function(t, e, n) {
        ...
        return h || (h = function(t) {
            ...
            if (e && r && i)
                return o = n.e(8).then(function(t) {
                    n(167);
                    var e = n(72).default;
                    return f.a.controls = n(70).default,
                    Object(l.a)(n(294).default),
                    e
                }
                .bind(null, n)).catch(Object(u.b)(d.s + 105)),
                u.a.html5 = o,
                o;
            var o;
            if (e && i)
    ...
    function E(t, e) {
        var n = [_(t)];
        return F(t) || n.push(Promise.resolve()),
        Promise.all(n)
    }
    function A(t, e) {
        var r = function() {
    ...
    function _(t) {
        ...
        if (n && n.code === S.a) {
            ...
            if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                return new j.a("//content.jwplatform.com/libraries/" + r + ".js").load().then((function() {
      ...
      , M = function(t) {
        ...
        return !Object(w.h)(n) || Object(w.f)(u) ? Promise.resolve() : new Promise((function(i) {
            return Object(w.i)(r, n).then((function(n) {
                ...
                if (!P(t)) {
                    if (!r)
                        throw new d.q(null,d.h);
                    e.localization = Object(w.a)(r, u),
                    i()
                }
            }
            )).catch((function(t) {
    ...
    var z = function() {
        ...
        return e.getAllItems = function() {
            ...
            return this.items.reduce((function(e, n) {
                ...
                return r && (e[n] = "captions" !== n ? Object(D.serialize)(r) : JSON.parse(r)),
                e
            }
            ), {})
        }
    ...
    var $ = function(t) {
        ...
        this.apiQueue = new i.a(this,["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setAllowFullscreen", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "setPip", "requestPip", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "stopCasting", "resize", "setCaptions", "setControls"],(function() {
            return !0
        }
        ))
    };
    ...
    Object(r.j)($.prototype, {
        ...
        init: function(t, e) {
            ...
            return i.on("change:errorEvent", J),
            this.setup.start(e).then((function(t) {
                var o = t.core;
                if (!o)
                    throw Object(d.y)(null, d.v);
                if (n.setup) {
                    n.on(b.ub, K),
                    ...
                    var s = n._model;
                    return i.off("change:errorEvent", J),
                ...
                n.setup && function(t, e, n) {
                    Promise.resolve().then((function() {
                        ...
                        if (!o) {
                            ...
                            Q.a.cloneIcon && u.querySelector(".jw-icon").appendChild(Q.a.cloneIcon("error")),
                            Z(t, u)
                        }
                        i.set("errorEvent", r),
                        i.set("state", b.lb),
        ...
        playerDestroy: function() {
            ...
            this.currentContainer !== this.originalContainer && Z(this, this.originalContainer),
            this.off(),
...
, function(t, e, n) {
    ...
    function b(t) {
        ...
        return m(e, t.ga, "gapro"),
        e
    }
    e.a = function(t, e) {
        var f, g, m, y = Object(i.b)(t, e), j = y.key || a.default.key, w = new c.b(j), O = w.edition();
        ...
        }, i.a, Object(r.C)(y, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]))),
        y.key = j,
        y.edition = O,
        y.error = w.error(),
        ...
        y.plugins = b(y),
        f = y.playlist,
        Object(r.x)(f) && f.indexOf("__CONTEXTUAL__") > -1 && (y.playlist = function(t, e) {
        ...
        Object(u.isFileProtocol)()) {
            var C = y
              ...
              , x = C.related;
            h(P) && (y.playlist = v(P)),
            x && h(x.file) && (x.file = v(x.file))
        }
        return y.__abSendDomainToFeeds && (m = y.playlist,
        /\.jwplatform.com|\.jwplayer.com/.test(m)) && (y.playlist = (g = y.playlist,
        g += (-1 !== g.indexOf("?") ? "&" : "?") + "page_domain=" + encodeURIComponent(Object(p.a)()))),
        y
    }
}
, function(t, e) {
